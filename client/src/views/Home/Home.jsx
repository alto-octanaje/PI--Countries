...
import { getCountries,filterContinent, filterPopulation, getActivities } from "../../Redux/action/action";
...
const Home=()=>{
    ...
    const currentCountries= allCountries.slice(indexOfFristCharacter,indexOfLastCountries);
    ...
    <div>
        <div>
            ...
            <select onChange={e=> handleFilterPopulations(e)}>
                    <option value='Min' key='min'>Population minima</option>
                    <option value='Max' key='max'>Population maxima</option>
                </select>
            </div>
